        ...
        <tr>
            ...
            <td>
              ...
              <table style="width:100%;text-align:center;" id="headerTable">
                <tr class="longtext"><td><?php echo $config->memo_header; ?></td></tr>
                ...
                <tr><td style="text-align:right;">Musak: {{ $branchinfo->musak }}</td></tr>
                 <tr><td style="text-align:right;">Vat. Reg. No: {{ $branchinfo->bin }}</td></tr>
        ...
        <tr>
            ...
            <td>
              ...
              <table style="width:100%;" id="subHeaderTable">
                ...
                <tr>
                  <td>SaleID: {{ Helper::viewSaleId($sale->id) }}</td>
            ...
            <td>
              ...
              <table style="width:100%;" id="footerTable">
                ...
                <tr>
                  ...
                  <td>Sub total after disq. </td>

                  <td style="text-align:right;">
                  <?php $after = $sale->subtotal - $sale->total_discount; ?>
                   {{ Helper::toCurrency($after) }}
                  </td>
