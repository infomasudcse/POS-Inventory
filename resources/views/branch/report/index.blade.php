          ...
          <div class="col-12 col-lg-4">
              <div class="card card-outline card-primary">
                  <div class="card-header">
                    <h2 class="" id="overview">Todays Overview</h2>
                  </div>
                  <div class="card-body" id="overview-body" style="display:none; padding:0.75rem;">                 
                      <table class="table">
                        <tr>
                          <td>Sale: </td>
                          <td> {{ Helper::toCurrency($overview['sale']) }}</td>
                        </tr>
                        <tr>
                          <td>Expense: </td>
                          <td> {{ Helper::toCurrency($overview['expense']) }}</td>
                        </tr>

                        <tr>
                          <th>Cash: </th>
                          <th> {{ Helper::toCurrency($overview['cash']) }}</th>
                        </tr>
                      </table>
                  </div>
              </div>
              ...
              <div class="col-12 col-lg-6">
                ...
                <div class="card card-outline card-success">
                  ...
                  <div class="card-body" style="display: block;padding:0.75rem;">
                    ...
                    <ol>
                      <li><a href="{{ route('expense') }}" > Today</a></li>
                      <li><a href="{{ url('branchReport/expenseYeasterday') }}" > Yesterday</a></li>
                    </ol>
