				...
				if($remainQty >= 0 ){
			   	...
			   	if($newInventory){
					//update old inventory
			   		...
			   		//track new inventory
			   		$this->SaveTrackInventory($newInventory->id,$newInventory->item_id,$user,$newInventory->branch_id,$newInventory->sku,$qty,'Transfer-Added');
			   		//track old inventory
			   		$this->SaveTrackInventory($originInventory->id,$originInventory->item_id,$user,$originInventory->branch_id,$originInventory->sku,'-'.$qty,'Transferred-To');
