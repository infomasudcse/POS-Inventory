        ...
        $employees = User::with('branch')->get();
         ...
         foreach($employees as $employee){
            $action = "<div class='btn-group'>
               ...
               $pstatus = "<a href='".url('/employee/status/'.$employee->id)."' class='clink'>". Helper::getUserStatus($employee->status) ."</a>";
               $canTransfer =  "<a href='".url('/employee/canTransferMode/'.$employee->id)."' class='clink'>". Helper::canTransfer($employee->canTransfer) ."</a>";        
